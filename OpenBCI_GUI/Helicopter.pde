...
//      serial_h = _serial_h;
      serial_h = new Serial(this, Serial.list()[0], 9600); //MAKE SURE TO MODIFY THIS
      command_str = _str;
      name =_name;
      counter = 0;
      ID = _ID;
...
//   command_dive = new Command(serialPort,"P","Dive",ID++);
   command_turnOnOff = new Command(serialPort, "O", "TurnLight", ID++);
     
  }
  
  public void turnOnOff(){
    prev_commnd = command_turnOnOff.issue();
  }
//  
//  public void climb() {
